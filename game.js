...
async function toggleFullscreen() {
  try {
    ...
    log('Fullscreen toggle blocked by browser.', true);
  }
}
...
document.addEventListener('keyup', (e) => {
  ...
  if (e.key.toLowerCase() === 'g') toggleFullscreen();
  if (e.key === 'Escape' && state.gameOver) closeOverlay();
});
